...
{
	std::string path = "Hydra/";
	std::string name = "HEADER.ytd";
	const std::string fullPath = path + name;
...
void Menu::Drawing::Title(const char* text, RGBAF rgbaf, VECTOR2 position, VECTOR2_2 size, bool center)
{
	...
	if (Menu::Settings::titleRectTexture == 0) {
		...
		Drawing::Spriter("HEADER", Features::current_header, Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Settings::titleRect.r, Settings::titleRect.g, Settings::titleRect.b, 255);
	}

	if (Menu::Settings::titleRectTexture == 1) {

		Drawing::Spriter("HEADER", "HEADER1", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 2) {

		Drawing::Spriter("HEADER", "HEADER2", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 3) {

		Drawing::Spriter("HEADER", "HEADER3", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 4) {

		Drawing::Spriter("HEADER", "HEADER4", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 5) {

		Drawing::Spriter("HEADER", "HEADER5", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}

	if (Menu::Settings::titleRectTexture == 6) {

		Drawing::Spriter("HEADER", "HEADER6", Settings::menuX, 0.0800f, 0.24f, 0.090f, 0, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
...
float Menu::Settings::scrollbarX = { Menu::Settings::menuX - 0.130f }; //menux - 2.0			Thx let me check a thing    |MenuX MenuY   X = 3.0 -1.5f
float Menu::Settings::ScrollerWidth = 0.01f;
...
RGBAF Menu::Settings::titleText3{ 239, 255, 255, 255, 1 };
...
RGBA Menu::Settings::scrollerr{ 0, 0, 50, 255 };
RGBAF Menu::Settings::title_end{ 255,255,255,255,4 };
RGBAF Menu::Settings::optionText{ 255, 255, 255, 255, 0 };
RGBAF Menu::Settings::TILE101010TEXT{ 0, 0, 140, 255, 7 };
RGBAF Menu::Settings::optionTextt{ 255, 255, 255, 180, 1 };
RGBA Menu::Settings::optionRect{ 0, 0, 0, 140 };
RGBA Menu::Settings::scroller{ 0, 0, 50, 255 };
RGBA Menu::Settings::line{ 255,255,255,255 };
RGBA Menu::Settings::hylent{ 0,0,255,255 };
...
RGBA Menu::Settings::Endrectloll{ 0, 0, 0, 255 };
...
void Menu::AddSmallTitle(char* text)
{
	if (Menu::Settings::menuX < 0.78f)
	{
		...
		Drawing::Spriter("commonmenu", "interaction_bgd", Settings::menuX + 0.200f, 0.1175f - 0.019f, 0.115f, 0.045f, 180, Menu::Settings::titleRect.r, Menu::Settings::titleRect.g, Menu::Settings::titleRect.b, Menu::Settings::titleRect.a);
	}
	else
	{
		Drawing::Text(text, Settings::titleText2, { Settings::menuX + 0.200f, 0.090f }, { 0.425f, 0.425f }, true);
	...
	if (Menu::Settings::currentOption <= Menu::Settings::maxVisOptions && Menu::Settings::optionCount <= Menu::Settings::maxVisOptions) {
		if (*prev != cur)
		{
			if (prevf < curf)
			{
				...
				GRAPHICS::DRAW_RECT(Menu::Settings::menuX, prevf, 0.24f, 0.035f, Menu::Settings::scrollerr.r, Menu::Settings::scrollerr.g, Menu::Settings::scrollerr.b, Menu::Settings::scrollerr.a);
				if (prevf >= curf)
				{
					prevf = curf;
					*prev = cur;
		...
		{
			*prev = cur;
			GRAPHICS::DRAW_RECT(Menu::Settings::menuX, cur * 0.035f + 0.1415f, 0.24f, 0.035f, Menu::Settings::scrollerr.r, Menu::Settings::scrollerr.g, Menu::Settings::scrollerr.b, Menu::Settings::scrollerr.a);
		}
	}
		...
		GRAPHICS::DRAW_RECT(Menu::Settings::menuX, ((Menu::Settings::optionCount - (Menu::Settings::currentOption - Menu::Settings::maxVisOptions)) * 0.035f + 0.1415f), 0.24f, 0.035f, Menu::Settings::scrollerr.r, Menu::Settings::scrollerr.g, Menu::Settings::scrollerr.b, Menu::Settings::scrollerr.a);
	}
};
...
void Menu::Bigtext(const char* title)
{
	...
	Drawing::Text(title, Settings::TILE101010TEXT, { Settings::menuX, 0.130f }, { 0.45f, 0.45f }, true);
...
bool Menu::Option(const char* option)
{
	...
	if (Settings::currentOption <= 16 && Settings::optionCount <= 16)
	{
		...
		onThis ? Drawing::Spriter("CommonMenu", "gradient_background", Settings::menuX, (Settings::optionCount) * 0.035f + 0.1415f, 0.24f, 0.035f, 0, Settings::scrollerr.r, Settings::scrollerr.g, Settings::scrollerr.b, Settings::scrollerr.a) : NULL;
	}
	else if (Settings::optionCount > (Settings::currentOption - 16) && Settings::optionCount <= Settings::currentOption)
	{
		...
		onThis ? Drawing::Spriter("frontend", "gradient_background", Settings::menuX, (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.1415f, 0.24f, 0.035f, 0, Settings::scrollerr.r, Settings::scrollerr.g, Settings::scrollerr.b, Settings::scrollerr.a) : NULL;
		Drawing::Spriter("frontend", "gradient_background", Settings::menuX, (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.1415f, 0.24f, 0.035f, 180, Settings::optionRect.r, Settings::optionRect.g, Settings::optionRect.b, Settings::optionRect.a);
...
bool Menu::Optionn(const char* option)
{
	...
	if (Settings::currentOption <= 16 && Settings::optionCount <= 16)
	{
		...
		Drawing::Rect(Settings::optionRect, { Settings::menuX, (Settings::optionCount) * 0.035f + 0.1415f }, { 0.24f, 0.035f });
		Drawing::Spriter("frontend", "gradient_background", Settings::menuX, (Settings::optionCount) * 0.035f + 0.1415f, 0.24f, 0.035f, 180, Settings::optionRect.r, Settings::optionRect.g, Settings::optionRect.b, Settings::optionRect.a);
		onThis ? Drawing::Rect(Settings::scroller, { Settings::menuX, (Settings::optionCount) * 0.035f + 0.1415f }, { 0.24f, 0.035f }) : NULL;
	...
	else if (Settings::optionCount > (Settings::currentOption - 16) && Settings::optionCount <= Settings::currentOption)
	{
		...
		Drawing::Rect(Settings::optionRect, { Settings::menuX,  (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.1415f }, { 0.24f, 0.035f });
		Drawing::Spriter("frontend", "gradient_background", Settings::menuX, (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.1415f, 0.24f, 0.035f, 180, Settings::optionRect.r, Settings::optionRect.g, Settings::optionRect.b, Settings::optionRect.a);
		onThis ? Drawing::Rect(Settings::scroller, { Settings::menuX,  (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.1415f }, { 0.24f, 0.035f }) : NULL;
...
bool Menu::MenuOptionn(const char* option, SubMenus newSub)
{
	...
	bool onThis = Settings::currentOption == Settings::optionCount ? true : false;
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
		Drawing::Text("~w~2~w~2", onThis ? Settings::arrow2 : Settings::arrow2, { Settings::menuX + 0.105f, Settings::optionCount * 0.035f + 0.128f }, { 0.22f, 0.22f }, true);


	else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption)
		Drawing::Text("~w~2~w~2", onThis ? Settings::arrowww : Settings::arrowww, { Settings::menuX + 0.105f, (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.12f }, { 0.22f, 0.22f }, true);
...
bool Menu::MenuOption(const char* option, SubMenus newSub)
{
	...
	bool onThis = Settings::currentOption == Settings::optionCount ? true : false;
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
		Drawing::Text("~d~>~d~>", onThis ? Settings::arrow2 : Settings::arrow, { Settings::menuX + 0.099f, Settings::optionCount * 0.035f + 0.128f }, { 0.25f, 0.25f }, true);
	else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption)
		Drawing::Text("~d~>~d~>", onThis ? Settings::arrow2 : Settings::arrow, { Settings::menuX + 0.099f, (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.12f }, { 0.25f, 0.25f }, true);
...
/*bool Menu::MenuOption(const char* option, SubMenus newSub)
{
	...
	bool onThis = Settings::currentOption == Settings::optionCount ? true : false;
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
		Drawing::Text("~w~>~w~>", onThis ? Settings::arrow2 : Settings::arrow, { Settings::menuX + 0.099f, Settings::optionCount * 0.035f + 0.128f }, { 0.25f, 0.25f }, true);
	else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption)
		Drawing::Text("~w~>~w~>", onThis ? Settings::arrow2 : Settings::arrow, { Settings::menuX + 0.099f, (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.12f }, { 0.25f, 0.25f }, true);
...
bool Menu::Toggle(const char * option, bool & b00l)
{
	...
	{
		if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
			Drawing::Spriter("commonmenu", "shop_box_tick", Settings::menuX + 0.096f, (Settings::optionCount * 0.035f + 0.141f), 0.027f, 0.047f, 0, 255, 255, 255, 255);
		else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption)
			Drawing::Spriter("commonmenu", "shop_box_tick", Settings::menuX + 0.096f, ((Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.141f), 0.027f, 0.047f, 0, 255, 255, 255, 255);
	}
	else
	{
		if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
			Drawing::Spriter("commonmenu", "shop_box_blank", Settings::menuX + 0.096f, (Settings::optionCount * 0.035f + 0.141f), 0.027f, 0.047f, 0, 255, 255, 255, 255);
		else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption)
			Drawing::Spriter("commonmenu", "shop_box_blank", Settings::menuX + 0.096f, ((Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.141f), 0.027f, 0.047f, 0, 255, 255, 255, 255);
	}
	if (Settings::optionCount == Settings::currentOption && Settings::selectPressed) {
		b00l ^= 1;
		return true;
...
bool Menu::Float(const char* option, float& _float, int min, int max)
{
	...
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions) {
		...
		Drawing::Text(Tools::StringToChar("(" + currStr.substr(0, (currStr2.length() + 3)) + ") ~w~/" + std::to_string(max)), Menu::Settings::optionText, { Settings::menuX + 0.073f, Settings::optionCount * 0.035f + 0.13f }, { 0.32f, 0.32f }, true);
	}
	else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption) {
		std::string currStr = std::to_string(_float);
		std::string currStr2(currStr.begin(), std::find(currStr.begin(), currStr.end(), '.'));
		Drawing::Text(Tools::StringToChar("(" + currStr.substr(0, (currStr2.length() + 3)) + ") ~w~/" + std::to_string(max)), Menu::Settings::optionText, { Settings::menuX + 0.073f, (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.13f }, { 0.32f, 0.32f }, true);
	}
...
bool Menu::StringVector(const char* option, std::vector<char*> Vector, int& position)
{
	...
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions) {
		...
		UI::BEGIN_TEXT_COMMAND_DISPLAY_TEXT("STRING");
		UI::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(Tools::StringToChar("[ " + SelectedChar + " ] ~w~" + std::to_string(position) + "/" + std::to_string(Vector.size() - 1)));
...
int CEOVIEW(char* text, char* text2, char* Subject)
{
...
int Menu::Settings::keyPressDelay = 100;
...
int Menu::Settings::keyPressDelay3 = 100;
...
void Menu::Files::StyleSaver::SaveStyles()
{
	...
	// Scroller
	WriteIntToIni(Settings::scrollerr.r, MenuStyleFile, "Scroller", "Red");
	WriteIntToIni(Settings::scrollerr.g, MenuStyleFile, "Scroller", "Green");
	WriteIntToIni(Settings::scrollerr.b, MenuStyleFile, "Scroller", "Blue");
	WriteIntToIni(Settings::scrollerr.a, MenuStyleFile, "Scroller", "Alpha");
}
...
void Menu::Files::StyleSaver::LoadStyles()
{
	...
	// Scroller
	Settings::scrollerr.r = ReadIntFromIni(MenuStyleFile, "Scroller", "Red");
	Settings::scrollerr.g = ReadIntFromIni(MenuStyleFile, "Scroller", "Green");
	Settings::scrollerr.b = ReadIntFromIni(MenuStyleFile, "Scroller", "Blue");
	Settings::scrollerr.a = ReadIntFromIni(MenuStyleFile, "Scroller", "Alpha");
}
